...
export function AdminDashboard() {
  ...
  const [activeDriverSection, setActiveDriverSection] = useState("pedidos")
        ...
        {activeActor === "administrador" && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">Gestiona envíos, comercios y genera reportes</p>
            </div>
        ...
        {activeActor === "chofer" && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">Gestiona tus entregas y rutas asignadas</p>
            </div>

            {/* Driver Navigation */}
            <Tabs value={activeDriverSection} onValueChange={setActiveDriverSection} className="space-y-6">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="ruta" className="flex items-center gap-2">
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="text-left py-3 px-4 font-medium text-gray-900">Comercio</th>
                                      ...
                                      <DialogContent className="backdrop-blur-sm bg-white/95">
                                        ...
                                        <div className="space-y-4">
                                          ...
                                          <div className="flex gap-2 pt-4">
                                            <Button
                                              onClick={() => handleDelivery(deliveryOrder?.id)}
              ...
              <TabsContent value="ruta" className="space-y-6">
                <div className="flex justify-between items-center">
